...
public class SubscribeController {
    ...
    public void subscribe(@PathVariable("uid") long publisher) throws EntityNotFoundException {
    ...
    public void unsubscribe(@PathVariable("uid") long publisher) throws EntityNotFoundException {
        val fan = bloggerService.getSelfBloggerId();
        subscribeService.unsubscribe(publisher, fan);
    }

    @GetMapping("/subscribed")
    public boolean subscribed(@PathVariable("uid") long publisher) {
        val fan = bloggerService.getSelfBloggerId();
