...
class BlogControllerTest {
    ...
    @Autowired
    public BlogControllerTest(WebApplicationContext wac) {
    ...
    void getBloggerInfo() throws Exception {
        ...
        mockMvc.perform(req)
                ...
                .andExpectAll(
                        ...
                        jsonPath("$.content.likeCount").value(0),
                        jsonPath("$.content.fans").value(0),
                        jsonPath("$.content.blogCount").value(5)

                );
    }

    @Test
    void getBlogAllPost() throws Exception {
        val req = MockMvcRequestBuilders
                .get("/blog/1/post")
